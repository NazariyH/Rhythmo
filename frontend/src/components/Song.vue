<template>
    <div class="card active" :data-songBlockId="song.id">
        ...
        <div class="player">
            ...
            <button class="like" v-on:click="likeOrUnlikeSong" :data-songId="song.id" v-if="!is_current_user">
                <span>{{ song_likes_length }}</span>
                <svg v-if="!song_is_liked" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
export default {
    ...
    methods: {
        ...
        async likeOrUnlikeSong() {
            ...
            try {
                ...
                this.song_is_liked = response.data.song_is_liked
                this.song_likes_length = response.data.song_likes_length
            } catch (error) {
                console.log(error)
            }
        }
    ...
    mounted() {
        ...
        this.song_likes_length = this.song.likes.length

        this.checkSongReactionStatus()
    }
}
</script>
